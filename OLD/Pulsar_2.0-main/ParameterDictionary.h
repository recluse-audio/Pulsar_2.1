...
/*
*/
class ParameterDictionary : public juce::ImageComponent, public Button::Listener
{
public:
    ParameterDictionary()
    {
    ...
    void loadSlides()
    {
        auto slides = juce::File("/Library/Application Support/Recluse-Audio/Pulsar/Pulsar Parameter Definitions").findChildFiles(2, true);
...
private:
    ...
    juce::StringArray tutorialImagePaths;

    juce::StringArray filePaths;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ParameterDictionary)
};
