...
public:
    ...
    void initFiles()
    {
        auto presetFolders = juce::File("/Library/Application Support/Recluse-Audio/Pulsar/User Presets/").findChildFiles(2, true);
    ...
    {
        juce::String filePath = "/Library/Application Support/Recluse-Audio/Pulsar/User Presets/";
